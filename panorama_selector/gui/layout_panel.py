...
class LayoutPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.view_orientation.addItem("Landscape", False)
        self.view_orientation.addItem("Portrait 90° 회전", True)
        ...
        form.addRow("카메라 방향", self.view_orientation)
        form.addRow("외형 clearance", self.clearance_mm)
        ...
        self.view_orientation.currentIndexChanged.connect(self._on_values_changed)
        self.clearance_mm.valueChanged.connect(self._on_values_changed)
    ...
    def get_config(self) -> LayoutConfig:
        ...
        return LayoutConfig(
            ...
            portrait_view=bool(self.view_orientation.currentData()),
            clearance_mm=self.clearance_mm.value(),
        )
